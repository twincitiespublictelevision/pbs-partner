...
PBSMediaEvents.prototype._resetTracking = function _resetTracking() {
  ...
  this.off('play', this._handlers.onInitialPlayEvent);
  this.off('play', this._handlers.startRecordingPlaybackData);
  this.off('pause', this._handlers.pauseRecordingPlaybackData);
  this.off('adPlay', this._handlers.pauseRecordingPlaybackData);
  this.off('complete', this._handlers.onVideoEnd);
  this.off('destroy', this._handlers.onVideoEnd);

  // Bind the handler that performs set up on the initial play event
  this.on('play', this._handlers.onInitialPlayEvent);

  // Bind the handler that records playback duration
  this.on('play', this._handlers.startRecordingPlaybackData);

  // Bind the handler that pauses the recording of playback duration
  this.on('pause', this._handlers.pauseRecordingPlaybackData);
  this.on('adPlay', this._handlers.pauseRecordingPlaybackData);
};
...
PBSMediaEvents.prototype._onInitialPlayEvent = function _onInitialPlayEvent() {
  ...
  this.on('complete', this._handlers.onVideoEnd);
  this.on('destroy', this._handlers.onVideoEnd);
};
